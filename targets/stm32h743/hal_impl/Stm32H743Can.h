...
/**
 * @brief hal::ICan implementation for STM32H743 using ST FDCAN HAL.
 */
class Stm32H743Can : public hal::ICan {
public:
    explicit Stm32H743Can(FDCAN_GlobalTypeDef* instance = FDCAN1);
    ~Stm32H743Can() override;
