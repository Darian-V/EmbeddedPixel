...
#define DebugRx_Pin GPIO_PIN_7
#define DebugRx_GPIO_Port GPIOB
#define DebugTx_Pin GPIO_PIN_6
#define DebugTx_GPIO_Port GPIOB
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* hqspi)
{
  if(hqspi->Instance==QUADSPI)
  {
    ...
    PD12     ------> QUADSPI_BK1_IO1
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_7|GPIO_PIN_8
                          |GPIO_PIN_9);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB6     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = DebugRx_Pin|DebugTx_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, DebugRx_Pin|DebugTx_Pin);
